...
const SHELTER_LOCATIONS: ShelterLocation[] = [
  { name: "Chase Center", lat: 39.7375, lng: -75.5477, type: ["flood", "hurricane/tornado", "earthquake"] },
  { name: "Bob Carpenter Center", lat: 39.6547, lng: -75.7505, type: ["flood", "hurricane/tornado", "earthquake"] },
...
interface GoogleMapProps {
  ...
  onShelterListChange: (shelters: ShelterLocation[]) => void; // Add this prop definition
}

const GoogleMap: React.FC<GoogleMapProps> = ({ 
  disasterType, 
  onLocationChange, 
  onClosestLocationChange,
  onShelterListChange
}) => {
  ...
  useEffect(() => {
    ...
    // Filter shelters based on disaster type
    const availableShelters = SHELTER_LOCATIONS.filter(shelter => 
        shelter.type.includes(disasterType.toLowerCase())
      );
      onShelterListChange(availableShelters);
    }, [disasterType, onShelterListChange]);
